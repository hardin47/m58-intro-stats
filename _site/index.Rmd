...
schedule <- tribble(
  ...
  "Week 2 <br> 1.25.22", 'Correlation + <br>Least<br>squares<br> ',"$\\boldsymbol{\\cdot}$  <br> $\\boldsymbol{\\cdot}$ <br> $\\boldsymbol{\\cdot}$ ", 
  ...
  "Week 3 <br> 2.1.22", 'Hyp Test + <br>Randomization<br>Test<br> ',"$\\boldsymbol{\\cdot}$  <br> $\\boldsymbol{\\cdot}$ <br> $\\boldsymbol{\\cdot}$ ", 
