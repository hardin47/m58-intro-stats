...
1. Group Members: List the members of your group. For the revised proposal, add additional information about each person's role. Each member of the group should have two jobs: (1) a group dynamic role, (2) a project role. See <a href = "https://m58-intro-stats.netlify.app/roles.html" target="_blank">Group Roles</a> for more information on allocating tasks.
