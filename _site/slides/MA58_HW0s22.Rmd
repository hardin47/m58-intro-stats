...
date: "due: Thursday, January 20, 2022"
output: pdf_document
---
...
Answer each question below by typing a response.  Knit the file to a compiled pdf, and submit it to Gradescope (via Sakai).
...
#### Q4. 
What is the software program we are using for the class?  After watching the R video on our Box video page (see Sakai for the link), ask one question that you have about R.  [If you are already familiar with R, you don't need to watch the video, but you surely can think up one question about R.]
