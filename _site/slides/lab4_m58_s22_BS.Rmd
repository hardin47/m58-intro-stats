...
We can tell that the bootstrapped proportions fall roughly between 0.30 and 0.36.  But we can quantify the interval of interest by finding the middle 90% or 95% of 99% of the bootstrapped proportions to correspond to the confidence interval values. 
