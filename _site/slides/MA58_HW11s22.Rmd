...
date: "due Thursday, April 21, 2022"
output: pdf_document
---
...
facet_grid( ~Doors)
```
(c)	Apply the log transformation to the head injury measurements.  Then examine boxplots or histogram of this transformed variable by number of doors.  Do these distributions appear to be roughly normally distributed?  
