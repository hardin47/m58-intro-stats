...
date: "due Thursday, March 31, 2022"
output: pdf_document
---
...
As with the mathematical chi-squared test, for the randomization test: state the hypotheses, find the observed $X^2$ value, calculate the p-value, and provide a conclusion in words of the problem.
