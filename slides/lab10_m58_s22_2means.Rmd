---
title: 'Lab 10 - Math 58B: Inference on Two Means'
...
We are 93% confident that the true difference in average weeks of gestation between mature versus younger moms is between -1.03 weeks and 0.066 weeks.  Note that because the confidence interval overlaps zero, we know that the value of zero is a plausible parameter.
