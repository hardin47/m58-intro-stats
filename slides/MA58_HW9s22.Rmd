...
date: "due Thursday, April 7, 2022"
output: pdf_document
---
...
Below you will find a series of examples^[See the following handout for more inferential summaries: https://m58-intro-stats.netlify.app/slides/param_est.pdf].  For each example, 

Assigned:  

* From the following list, which procedure would you follow to address the issue in the example?
...
| (3) \ z-test of a proportion                          | (4) \ One sample t-test of a mean  |
| (5) \ Prediction interval for individual observation                     | (6) \ One sample t-interval for a mean        |
| (5) \ z-interval for OR / RR                          | (6) \ Bootstrap interval for OR/ RR   |
| (5) \ Two sample bootstrap interval for proportions                          | (6) \ Two sample z-interval for proportions   |
| (7) \ Two sample t-test of means                      | (8) \ Two sample t-interval for means         |
| (9) \ Two sample randomization test,                  | (10) \ Two sample randomization test,       |
| two categorical variables                                  | one binary, one quantitative                      |
| (11) \ Two sample z-test of proportions        | (12) \ Chi-square test                        |
| (13) \ none of the above are appropriate        |       |
