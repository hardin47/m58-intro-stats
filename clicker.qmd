...
123.  What is the correct interpretation of the 92% CI for $\mu$ which is given as (98.2, 98.3)?[^123]
...
[^123]: e. In repeated samples, 92% of the intervals will contain $\mu$. Also good interpretation for a CI: f. We are 92% confident that the interval (98.2, 98.3) captures the true average temperature, $\mu$.

---

124. Let's say you *truly* believe that the true average body temp is between (98.2, 98.3). (Your CI is green.) You record a temp of 98.6 F.  Do you think you are sick?[^124]
...
[^124]: d. No, the interval isn't for individual people.

---

125.  The variability associated with $\overline{X}$ is[^125]
      (a) less than the variability of X
      (b) more than the variability of X
      (c) the same as the variability of X
      (d) unrelated to the variability of X
...
[^125]: a. less than the variability of X

---

126.  The variability associated with predicting a new value, $X_{n+1}$,[^126]
...
[^126]: b. is more than the variability of $\overline{X}$

---

127.  Prediction intervals are[^127]
...
[^127]: c. larger than confidence intervals

---

128. Where should a prediction interval for a new value, $X_{n+1}$, be centered?[^128]
      (a) $\overline{X}$
      (b) $\mu$
      (c) 98.6
...
129.  What is the correct interpretation of the 95% PI for $X_{n+1}$ which is given as (96.79, 99.70)?[^129]
...
[^129]: b. 95% of individual temperatures will be between (96.79, 99.70).

---

130. Prediction intervals have[^130]
...
[^130]: b. stricter technical conditions than CIs

---

131.  When the population is skewed right, the sampling distribution for the sample mean will be[^131]
      (a) always skewed right
      (b) skewed right if n is big enough
      (c) always normal
      (d) normal if n is big enough

[^131]: d. normal if n is big enough

---

132.  When the population is skewed right, the distribution for the data will be[^132]
      (a) always skewed right
      (b) skewed right if n is big enough
      (c) always normal
      (d) normal if n is big enough

[^132]: a. always skewed right

---

133. A newspaper article claims that the average age for people who receive food stamps is 40 years. You believe that the average age is lower. You take a random sample of 100 people who receive food stamps and find their average age to be 39.2 years. You find that 39.2 is significantly lower than the age of 40 stated in the article (p < 0.05). What would be an appropriate interpretation of the result?[^133]
...
[^133]: b. Although the result is statistically significant, the difference in age is not of practical importance.

---

134. In order to investigate a claim that the average time required for the county fire department to respond to a reported fire is greater than 5 minutes, county staff determined the response times for 40 randomly selected fire reports.  The data were used to test $H_0: \mu = 5$ versus $H_a:  \mu > 5$, and the computed p-value was 0.12.  If a 0.05 level of significance is used, what conclusions can be drawn?[^134]
...
[^134]: c. There is not convincing evidence that the mean response time is greater than 5 minutes.
