...
73. Sample 1,000,000 people who are over 6’ tall and 1,000,000 people who are under 6’ tall.  Record if the person is in the NBA.  
What is measurable?
(a) P(NBA if 6’ tall)
...
(cohort: cannot measure the probability of the explanatory variable given the response) 

74.  Sample 100 people who are in the NBA and 100 people who are not in the NBA. Record if the person is over 6’ tall. What is measurable?
(a) P(NBA if 6’ tall)
(b) P(6’ tall if in the NBA)
(c) both
(d) neither  

(case-control:  cannot measure the probability of the response variable given a level of the explanatory variable)
 
75.  Sample 10,000,000 people.  Record their height and whether or not they are in the NBA.  
What is measurable?
(a) P(NBA if 6’ tall)
(b) P(6’ tall if in the NBA)
(c) both
...
(cross-classification: can measure all the probabilities)

76.  When we randomly select individuals based on the explanatory variable, we cannot accurately measure
...
77. The odds ratio is invariant to which variable is explanatory and which is response means:
...
 
78.  One reason we should be careful interpreting relative risks is if:
