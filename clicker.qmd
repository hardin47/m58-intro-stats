...
43. I know where to find: the solutions to the worksheets, the clicker questions (with solutions), and the HW/Lab solutions[^43]
     (a) TRUE
     (b) FALSE
...
83.	 Would it be reasonable for the alien to conclude, with 95% confidence, that between 17.4% and 34.6% of US Senators in the year 2026 self-identify as female?[^83]
     (a)	Yes
     (b)	No
...
172. Holding constant the city, additional 1% of mortgage rate would predict average ________ in the mean demand.[^172] 
$$\hat{Y} =  10 + 5X_1 + 8X_2$$
