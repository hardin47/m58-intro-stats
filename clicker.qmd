...
(@) First study: Let's say you take a random sample and compute $\hat{p}=0.3.$  After bootstrapping, you see that the bootstrapped resamples produce almost all the $\hat{p}_{boot}$ within plus or minus 0.01 of your original statistic. It seems that the parameter $p$ is probably:[^46]
	   a. 0.3
	   b. between (0.2, 0.4)
	   c. between (0.29, 0.31)
	   d. between (0.28, 0.32)
...
(@) Let's say that the null hypothesis (e.g., p=0.47) is TRUE.   My level of discernibility is 0.03 (reject if p-value < 0.03). How often will I reject the null hypothesis?[^67]
     (a) 1 % of the time
     (b) 3% of the time
     (c) 5 % of the time
     (d) 95% of the time
...
(@) Let's say that the null hypothesis (e.g., p=0.47) is TRUE.   My level of discernibility is 0.03.  
