...
(@) Is the Alien's interval for the true proportion of all humans who self-identify as female consistent with your lived experience?[^81]
    (a) Yes
    (b) No
...
(@) As we've seen with the applet, about 5% of all 95% intervals fail to capture the actual value of the population parameter.  Do you think the alien just got a "red" interval?[^82]
    (a)	Yes
    (b)	No
...
(@) Would it be reasonable for the alien to conclude, with 95% confidence, that between 17.4% and 34.6% of US Senators in the year 2026 self-identify as female?[^83]
     (a)	Yes
     (b)	No
