...
29. "Observed data or more extreme" is:[^29]
    (a) fewer than 9
    (b) 9 or fewer
    (c) 9 or more
    (d) more than 9
...
30. What is the mean value of the null sampling distribution for the number of Botox therapy who showed pain reduction?[^30]
    (a) 0
    (b) 9
    (c) 5.3
    (d) 11
...
[^30]: c. 5.3 because (15/31)*11 = 5.3

---

28. In the Botox and Pain Relief example, the p-value is calculated.  What does "probability" refer to?[^28]
    (a) random allocation
    (b) random sample

[^28]: a. random allocation
