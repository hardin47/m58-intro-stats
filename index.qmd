...
schedule <- tribble(
  ...
  'Week 8 <br> 3.9.26', ' Case-control + <br> cohort studies', '• Case-control <br> • Cohort ',
  '<a href="https://st47s.com/Math58/Notes/03-InfCat.html#rr" target = "_blank"><i class="fas fa-book-open"></i> RR</a>  <br> <a href="https://st47s.com/Math58/Notes/03-InfCat.html#or" target = "_blank"><i class="fas fa-book-open"></i> OR</a>',
  ...
  "Week 10 <br> 3.30.26", '1 mean +<br>pred interval',"• dist of X-bar <br> • SE(X-bar) <br> • t-test of μ<br> • t-CI for μ <br> • PI for X_{n+1}", 
