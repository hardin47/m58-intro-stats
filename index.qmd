...
schedule <- tribble(
  ...
  "Week 1 <br> 1.18.22", 'Intro + <br> variables &  <br> studies <br> SLR',"• course info <br> • tests <br> • studies", 
  ...
  "Week 2 <br> 1.25.22", 'Correlation + <br>Least<br>squares<br> ',"• causation <br> • correlation<br> • linear<br>model <br> • correlation<br> • $R^2$", 
  ...
  "Week 3 <br> 2.1.22", 'Hyp Test + <br>Randomization<br>Test<br> ',"•  structure of<br> hypothesis<br> testing", 
  ...
  "Week 4 <br> 2.8.22", 'Bootstrapping',"• boot samp dist <br> • boot CI ", 
  ...
  "Week 5 <br> 2.15.22", 'normality +<br>CLT',"• normal dist<br> • CLT<br> • Z-score <br> • empirical rule <br> • conf int <br> • norm prob <br> • hyp test", 
  ...
  "Week 6 <br> 2.22.22", 'Errors + <br>Power +<br>Sampling',"• Type I error <br> • Type II error <br> • Power <br> • biased samples", 
  ...
  "Week 7 <br> 3.1.22", 'Rel Risk +<br>Odds Ratios',"•  RR <br> • OR<br> • Case-control <br> • Cohort ", 
...
'<font color = "#114B5F"><b>3.10.22</b></font>', '<font color = "#114B5F"><b>Exam 1</b></font>',"", 
  ...
  "Week 9 <br> 3.22.22", '$\\chi^2$ Test',"• expected counts <br> • $X^2$ statistic <br> • $\\chi^2$ test", 
  ...
  "Week 10 <br> 3.29.22", '1 mean +<br>pred interval',"• dist of $\\overline{X}$ <br> • $SE(\\overline{X})$ <br> • t-test of $\\mu$  <br> • t-CI for $\\mu$  <br> • PI for $X_{n+1}$", 
...
'<font color = "#114B5F"><b>3.29.22</b></font>', '<font color = "#114B5F"><b>Proj 1: Pilot</b></font>',"", 
  ...
  "Week 11 <br> 4.5.22", '2 means +<br>t-proced',"• dist of $\\overline{X}_1 - \\overline{X}_2$ <br> • $SE(\\overline{X}_1 - \\overline{X}_2)$ <br> • t-test of $\\mu_1 - \\mu_2$ <br> • t-CI for $\\mu_1 - \\mu_2$", 
...
'<font color = "#114B5F"><b>4.5.22</b></font>', '<font color = "#114B5F"><b>Proj 2: Power Analysis</b></font>',"", 
  ...
  "Week 12 <br> 4.12.22", 'ANOVA',"• MSG <br> • MSE <br>• F-test ", 
  ...
  "Week 13 <br> 4.19.22", 'Inference $\\beta_1$ + <br>Tech cond + <br>MLR',"•  SE($\\beta_1$) <br> • residual plots <br> • multiple X", 
